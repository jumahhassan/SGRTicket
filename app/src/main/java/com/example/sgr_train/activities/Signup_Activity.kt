...
class Signup_Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.signUpBtn.setOnClickListener {
            val signup = SignUpAsyncTask(applicationContext)
            signup.execute()
        }
        ...
        class SignUpAsyncTask internal constructor(context: Context) : AsyncTask<String, String, String>() {
            ...
            override fun doInBackground(vararg params: String?):  String? {
                try {
                    ...
                    val url: String = "https://sgrtransport.000webhostapp.com/sgr/create.php"
                    val obj = URL(url)
            ...
            override fun onPostExecute(result: String?) {
                ...
                if (code == 1) {
                    Toast.makeText(cont, "Sign  Up Successful", Toast.LENGTH_SHORT).show()

                    val toMain = Intent(cont, Login_Activity::class.java)
